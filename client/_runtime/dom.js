...
function _collect(view) {
    ...
    for (const id in view._virtual) {
        ...
        // SCROLL POSITION
        if (virtual._overflow_y === "scroll" || virtual._overflow_y === "auto") { virtual._scroll_top = real.scrollTop }
...
function _update(view) {
    ...
    for (const id in view._virtual) {
        ...
        if (virtual._image_position !== prev._image_position || virtual.SETUP) {
        ...
        if (virtual._image_fit !== prev._image_fit || virtual.SETUP) {
        ...
        // BORDER
        if (virtual._border_left !== prev._border_left || virtual.SETUP) { 
            real.style.borderLeftStyle = virtual._border_left
            prev._border_left = virtual._border_left
        }
        if (virtual._border_top !== prev._border_top || virtual.SETUP) { 
            real.style.borderTopStyle = virtual._border_top
            prev._border_top = virtual._border_top
        }
        if (virtual._border_right !== prev._border_right || virtual.SETUP) { 
            real.style.borderRightStyle = virtual._border_right
            prev._border_right = virtual._border_right
        }
        if (virtual._border_bottom !== prev._border_bottom || virtual.SETUP) { 
            real.style.borderBottomStyle = virtual._border_bottom
            prev._border_bottom = virtual._border_bottom
        }
        
        // BORDER SIZE
        if (virtual._border_size !== prev._border_size || virtual.SETUP) {
        ...
        // OVERFLOW
        if (virtual._overflow_x !== prev._overflow_x || virtual.SETUP) { 
            real.style.overflowX = virtual._overflow_x 
            prev._overflow_x = virtual._overflow_x
        }
        if (virtual._overflow_y !== prev._overflow_y || virtual.SETUP) { 
        ...
        // VISIBILITY
        if (virtual._visible !== prev._visible || virtual.SETUP) {
