...
export function setup() {
    ...
    const context = {
        ...
        _location: {
            ...
            _switch: () => {
                if (context._location._push) {
                    ...
                    window.history.replaceState(null, null, context._location.path)
                    return
                }
        ...
        // @
        route(location, incoming=()=>{}, outgoing=()=>{}) {

            if (context.location().SWITCH) {
                if (context.location().path === location) {
                    incoming()
                }
                else if (context.location()._prev === location) {
                    outgoing()
                }
            }
        },
