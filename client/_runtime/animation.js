    ...
    if (id in element._anims) { 
        ...
        a = {
            ...
            update() {
                ...
                // PROGRESS
                if (a._progress >= a._distance) { a._property(a._end) }
                else {
                ...
                // TIME
                if (a._run_timer >= a._time) { _state(a, "DONE") }
                else { a._run_timer += delta * 1000 }
